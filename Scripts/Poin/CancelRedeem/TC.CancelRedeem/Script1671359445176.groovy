...
Mobile.startApplication('C:\\Users\\ASUS\\Downloads\\app-release (2).apk', true)
	...
	Mobile.tap(findTestObject('Object Repository/CancelRedeem/android.widget.ImageView'), 0)
	
	Mobile.tap(findTestObject('Object Repository/CancelRedeem/android.widget.ImageView (1)'), 0)
	
	Mobile.tap(findTestObject('Object Repository/CancelRedeem/android.view.View (1)'), 0)
	
	Mobile.tap(findTestObject('Object Repository/RedeemKoinn/android.widget.ImageView - 62'), 0)
	
	Mobile.setText(findTestObject('Object Repository/RedeemKoinn/android.widget.ImageView - 62 (1)'), '+6281370411036', 0)
	
	Mobile.hideKeyboard()
	
	Mobile.tap(findTestObject('Object Repository/CancelRedeem/android.view.View (2)'), 0)
