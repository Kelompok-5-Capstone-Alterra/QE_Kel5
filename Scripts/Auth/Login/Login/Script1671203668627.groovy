...
for (i = 1; i <= x; i++) {
    ...
    Mobile.sendKeys(findTestObject('Object Repository/BuyPulsa.01/android.widget.ImageView - Masukan email (1)'), findTestData(
            'Login').getValue(1, i))

    Mobile.tap(findTestObject('Object Repository/BuyPulsa.01/android.widget.EditText -'), 0)

    Mobile.sendKeys(findTestObject('Object Repository/BuyPulsa.01/android.widget.EditText - (1)'), findTestData('Login').getValue(
            2, i))
