...
int x = findTestData('KodePromo').getRowNumbers()
...
//    0)
Mobile.setText(findTestObject('Object Repository/BuyPulsa.01/android.widget.EditText - 62, Contoh  08571287123 (1)'), '+6281370411036', 
    0)
    ...
    Mobile.tap(findTestObject('Object Repository/Coba/android.widget.EditText - Masukkan Kode'), 0)

    Mobile.sendKeys(findTestObject('Object Repository/Coba/android.widget.EditText - Masukkan Kode (1)'), findTestData('KodePromo').getValue(
            2, i))

    Mobile.tap(findTestObject('Object Repository/Coba/android.view.View'), 0)
